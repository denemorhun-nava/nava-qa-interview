...
Test Application: LoginPage

Context
You are testing the login page for an application. Read through the scenario.
...
API
GET /v1/user/login?username=<username>&password=<password>
GET /v1/user/login?token=<token>
POST /v1/user/account/create
body: { username: <username>, password: <password>, email: <email> }
POST /v1/user/account/account_email
	body: { username: <username>, type: <email_type> }
email_type can be either “forgot_password” or “forgot_username”
